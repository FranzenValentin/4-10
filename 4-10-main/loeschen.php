...
<head>
    <!-- Diese datei ist die Lösch-Bestätigung -->
    <meta charset="UTF-8">
...
<body>
    ...
    if ($action == "löschen") {
        ...
        echo "<a href='loeschen.php?bestätigung=1&id_kunden=$P_ID' class='a'>ja</a> 
            <a href='output.php' class='a'>nein</a>"; //ja/nein Buttons
    }
    ...
    if ($bestätigung == "1") {
        Mysqli_query($con, "DELETE FROM personen WHERE P_ID='$P_ID'") or die(mysqli_error($con)); //falls auf ja gedrückt wird, werden die Daten hier gelöscht
